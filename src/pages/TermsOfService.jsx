...
export default function TermsOfService() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '24px 16px', fontFamily: 'inherit', lineHeight: 1.6, color: '#2d3748' }}>
      ...
      <p style={{ color: '#718096', fontSize: '0.85rem', marginTop: 0 }}>Last updated: July 4, 2026</p>

      <div style={{ background: '#fff8e1', border: '1px solid #f0c36d', borderRadius: 8, padding: '14px 16px', margin: '16px 0' }}>
        <strong style={{ display: 'block', marginBottom: 6 }}>⚠️ Please read this first</strong>
        <p style={{ margin: '0 0 8px' }}>
          This app is a <strong>free tool built and run by one person</strong> — a hobbyist, not a
          software company and not a licensed counseling or medical service. We take reasonable care
          with your information, but <strong>no online tool is ever perfectly secure.</strong>
        </p>
        <p style={{ margin: '0 0 8px' }}>
          <strong>Please don&apos;t enter anything you would not want someone else to see.</strong>
          If you write about sensitive struggles, keep it general — describe the category, not the
          graphic detail. You never need to name names or include anything that could identify you
          or others.
        </p>
        <p style={{ margin: 0 }}>
          <strong>You don&apos;t have to use your real name.</strong> A first name or a nickname is
          completely fine. Sharing less protects you.
        </p>
      </div>
